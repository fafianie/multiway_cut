...
//cout << "target value: " << galois -> toString(column[pivot]) << endl;;
//cout << "pivot value: " << galois -> toString(divisor) << endl;
//cout << "ratio: " << galois -> toString(ratio) << endl;
...
//cout << "ratio target: " << galois -> toString(independentColumns[independentElement][row]) << endl;
//cout << "factor: " << galois -> toString(factor) << endl;
		uint64_t oldFieldValue = column[row];
//cout << "old value: " << galois -> toString(oldFieldValue) << endl;
...
//cout << "new value: " << galois -> toString(newFieldValue) << endl;
	}
